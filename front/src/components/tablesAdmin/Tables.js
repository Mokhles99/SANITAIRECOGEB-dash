...
const Tables = () => {
    ...
    const cartColumns = [
        ...
        { field: 'remarque', headerName: 'Dimensions souhaités', width: 150 },
    ...
    const cartRows = carts.map(cart => {
        ...
        return {
            ...
            remarque: cart.userInfo?.remarque || 'Unknown',
            total: cart.total,
    ...
    {item.product?.name || 'Unknown'} &nbsp;(Qty: {item.quantity} m<sup>2</sup>)
</div>
